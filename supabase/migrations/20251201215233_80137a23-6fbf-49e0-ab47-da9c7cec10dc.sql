-- Drop existing trigger correctly with CASCADE
DROP TRIGGER IF EXISTS on_nutrition_assessment ON nutrition_assessments;
DROP FUNCTION IF EXISTS calculate_diet_score() CASCADE;

-- Create updated function with correct scoring logic
...
DECLARE
    ...
    winner_id TEXT := 'flexivel'; -- Fallback padrão
BEGIN
    -- ========== JEJUM INTERMITENTE ==========
    -- Pontos positivos
    ...
    -- Salva o resultado na assessment
