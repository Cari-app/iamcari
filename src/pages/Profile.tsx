        ...
        <div className="relative z-10">
          ...
          <div className="px-4 pt-4">
            <div className="grid grid-cols-3 gap-3">
              <button onClick={() => navigate('/nutrition-quiz')} className="relative p-4 rounded-2xl bg-white dark:bg-card flex flex-col items-center gap-2 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1),0_0_0_1px_rgba(132,204,22,0.1)] dark:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.4),0_0_0_1px_rgba(132,204,22,0.15)] hover:shadow-[0_8px_30px_-4px_rgba(132,204,22,0.2)] press-effect transition-all duration-300 overflow-hidden">
                ...
                <span className="text-xs font-semibold text-foreground text-center">Mapeamento</span>
              </button>
              
              <button onClick={() => navigate('/diets')} className="relative p-4 rounded-2xl bg-white dark:bg-card flex flex-col items-center gap-2 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1),0_0_0_1px_rgba(132,204,22,0.1)] dark:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.4),0_0_0_1px_rgba(132,204,22,0.15)] hover:shadow-[0_8px_30px_-4px_rgba(132,204,22,0.2)] press-effect transition-all duration-300 overflow-hidden">
                <div className="absolute top-0 left-2 right-2 h-0.5 rounded-b-full bg-gradient-to-r from-green-500 via-lime-400 to-green-500" />
                <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-lime-400/20 to-green-500/20 flex items-center justify-center">
                  <Utensils className="h-5 w-5 text-lime-500" />
                </div>
                <span className="text-xs font-semibold text-foreground text-center">Dietas</span>
              </button>
          ...
          {activeDiet && <div className="px-4 pt-4">
              <div className="relative p-4 rounded-2xl bg-white dark:bg-card shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1),0_0_0_1px_rgba(132,204,22,0.1)] dark:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.4),0_0_0_1px_rgba(132,204,22,0.15)] overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-3 pl-2">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => navigate('/diet-result')} className="h-7 text-xs text-lime-600 dark:text-lime-400 hover:text-lime-700 dark:hover:text-lime-300">
                    Ver detalhes
                ...
                <div className="flex items-center gap-4 pl-2">
                  {/* Diet Icon */}
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl bg-gradient-to-br from-lime-400/20 to-green-500/20 ring-2 ring-lime-500/30">
                    {activeDiet.icon}
                  </div>

                  {/* Diet Info */}
                  <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-bold mb-1 text-lime-600 dark:text-lime-400">
                      {activeDiet.name}
                    </h3>
