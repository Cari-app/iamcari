        ...
        >
          {isStandalone || installed ? (
            ...
            <div className="space-y-4">
              ...
              {isIOS && showIOSSteps && (
                <p className="text-sm text-muted-foreground text-center bg-card rounded-xl p-4 border border-border">
                  📱 No iPhone, toque em <Share className="inline h-4 w-4 text-primary" /> <strong>Compartilhar</strong> (barra do Safari) → <strong>"Adicionar à Tela de Início"</strong>
                </p>
              )}
