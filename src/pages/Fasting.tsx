          ...
          <main className="px-4 space-y-4">
            ...
            {!isActive ? (
              <Button
                ...
                className="w-full h-14 rounded-2xl bg-gradient-to-r from-lime-900 to-lime-500 hover:from-lime-800 hover:to-lime-400 text-white font-bold text-base shadow-lg"
              >
