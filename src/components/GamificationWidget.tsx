...
export function GamificationWidget() {
  ...
  return (
    <motion.button
      ...
      className="flex items-center gap-2 press-effect rounded-xl hover:bg-accent/5 p-1.5 transition-colors"
    ...
    >
      ...
      <div className="hidden sm:flex flex-col items-start gap-0.5 min-w-[80px]">
